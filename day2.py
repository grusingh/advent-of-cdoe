...
def parse_game_from_string(val):
    ...
    max_r = max([r[0] for r in rolls])
    max_g = max([r[1] for r in rolls])
    max_b = max([r[2] for r in rolls])
    powerset = (max_r, max_g, max_b)
    power = max_r * max_g * max_b
    return (id, rolls, val, power, powerset)
...
class TestDay2(unittest.TestCase):
    ...
    def test_parse_value(self):
        self.assertEqual(parse_game_from_string(
            'Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green'), (1, [[4, 0, 3], [1, 2, 6], [0, 2, 0]], 'Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green', 48, (4, 2, 6)))
        self.assertEqual(parse_game_from_string(
            'Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue'), (2, [
                [0, 2, 1],
                [1, 3, 4],
                [0, 1, 1]
            ], 'Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue', 12, (1, 3, 4)))
        self.assertEqual(parse_game_from_string(
            'Game 31: 9 blue, 6 red, 7 green; 20 red, 1 green, 15 blue; 6 blue, 7 green, 17 red; 2 blue, 3 green, 6 red; 1 red, 3 blue, 2 green; 5 green, 18 red, 6 blue'), (31, [
                ...
                [1, 2, 3],
                [18, 5, 6],
            ], 'Game 31: 9 blue, 6 red, 7 green; 20 red, 1 green, 15 blue; 6 blue, 7 green, 17 red; 2 blue, 3 green, 6 red; 1 red, 3 blue, 2 green; 5 green, 18 red, 6 blue', 2100, (20, 7, 15)))
    ...
    def test_power_of_games(self):
        ...
        total = power_of_games(lines)
        self.assertEqual(total, 2286)

    def test_power_of_games_part2(self):
        lines = read_input()
        total = power_of_games(lines)
        self.assertEqual(total, 84911)
